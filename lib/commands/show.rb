Leafman::Command.new "show", "<project-name>", "show everything known about the project called <project-name>" do |pname|
    ...
    puts "...\tuses \e[32m\e[1mGit\e[0m#{" and syncs from \e[36m#{p['fetch']}\e[0m" if p['fetch']}." if p['scm'] == 'git'
    puts "...\tuses \e[34m\e[1mSubversion\e[0m#{" and syncs" if p['do_update']}." if p['scm'] == 'svn'
    puts "...\tuses \e[33m\e[1mBazaar\e[0m#{" and syncs" if p['do_update']}." if p['scm'] == 'bzr'
    puts "...\tuses \e[36m\e[1mMercurial\e[0m#{" and syncs" if p['do_pull']}." if p['scm'] == 'hg'
    puts "...\tuses \e[35m\e[1mDarcs\e[0m#{" and syncs" if p['do_pull']}." if p['scm'] == 'darcs'
